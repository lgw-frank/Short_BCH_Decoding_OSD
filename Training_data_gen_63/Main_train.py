...
sys.argv = "python 2.6 2.6 100 100 BCH_63_45_3_strip.alist".split()
...
if GL.get_map('ALL_ZEROS_CODEWORD_TRAINING'):
    file_name = file_dir + 'bch-train-allzero.tfrecord'
else:
    file_name =  file_dir + 'bch-train-nonzero.tfrecord'
